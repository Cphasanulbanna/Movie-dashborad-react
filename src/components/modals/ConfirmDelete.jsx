...
const ConfirmDelete = ({ deleteItem, closeModal, state, buttonLoader }) => {
    return (
        <section
            className={`overlay flex-center ${state ? "visible" : "hidden"}`}
            onClick={closeModal}
        >
            <div
                onClick={(e) => e.stopPropagation()}
                className="flex-column justify-center items-center bg-text-white p-[30px] rounded-[10px] gap-[20px] relative lg2:w-[375px] sm3:w-[300px]"
            >
